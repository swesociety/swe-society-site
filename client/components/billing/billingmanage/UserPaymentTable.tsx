...
const UserPaymentsTable: React.FC = () => {
  ...
  const handleDelete = async (paymentId: number) => {
    try {
      await axios.delete(
        `${APIENDPOINTS.billing.deletePayment}/${paymentId}`,
        headerConfig(),
      );
  ...
  return (
    <div className="p-4 w-full space-y-6">
      ...
      {/* Other Payment Receipts Table */}
      <div className="space-y-4">
        <h2 className="text-xl font-bold">Other Payment Receipts</h2>
                    ...
                    <td className="p-2 border">
                      {payment.transaction_slip ? (
                        <Button
                          ...
                          onClick={() =>
                            setModalSlipUrl(payment.transaction_slip!)
                          }
                        >
                          View
                        </Button>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 p-4 rounded-lg max-w-md w-full relative">
            ...
            <Image
              ...
              width={500}
              height={500}
              className="rounded border max-h-[500px] w-auto mx-auto"
            />
