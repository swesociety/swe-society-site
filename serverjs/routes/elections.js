...
const { validateBearerToken } = require("../middlewares/validateBearerToken.js");
  ...
  router.route("/executive-committees").get(getAllExecutiveCommittees);
  router.route("/executive-committees/create").post(validateBearerToken, createExecutiveCommittee);
  router.route("/executive-committees/:committeeid").put(validateBearerToken, updateExecutiveCommittee);
  router.route("/executive-committees/:committeeid").delete(validateBearerToken, deleteExecutiveCommittee);
